...
public class Main {
	...
	public static void addRecipe() {
	    ...
	    //Read in amt coffee
	    final String coffeeString = inputOutput("%nPlease enter the units of coffee in the recipe: ");
	    ...
	    //Read in amt milk
	    final String milkString = inputOutput("%nPlease enter the units of milk in the recipe: ");
	    ...
	    //Read in amt sugar
	    final String sugarString = inputOutput("%nPlease enter the units of sugar in the recipe: ");
	    ...
	    final String chocolateString = inputOutput("%nPlease enter the units of chocolate in the recipe: ");
    ...
    public static void addInventory() {
	    //Read in amt coffee
    	final String coffeeString = inputOutput("%nPlease enter the units of coffee to add: ");
	    ...
	    //Read in amt milk
	    final String milkString = inputOutput("%nPlease enter the units of milk to add: ");
	    final int amtMilk = stringToInt(milkString);
	    if(amtMilk < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt sugar
	    final String sugarString = inputOutput("%nPlease enter the units of sugar to add: ");
	    ...
	    //Read in amt chocolate
	    final String chocolateString = inputOutput("%nPlease enter the units of chocolate to add: ");
